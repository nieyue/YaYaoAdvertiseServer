...
public class MyRedis {
	  ...
	  //访问密码
	    private static String AUTH = "liliu";
	    ...
	    public static ShardedJedis getShardedJedis(){
	    	return new MyRedis().shardedJedis;
	    }
	    ...
	    { 
	        ...
	        jedisPool = new JedisPool(config,"120.25.228.28",6379,TIMEOUT,AUTH);
	    }
	    ...
	    { 
	        ...
	        JedisShardInfo jedisShardInfo = new JedisShardInfo("120.25.228.28", 6379, "master");
	     ...
	     */
	      private void KeyOperate() {
	          ...
	          // 判断key否存在 
	          System.out.println("判断xu999键是否存在："+shardedJedis.exists("xu999")); 
	          System.out.println("新增xu001,value001键值对："+shardedJedis.set("xu001", "value001")); 
	          System.out.println("判断xu001是否存在："+shardedJedis.exists("xu001"));
	          // 输出系统中所有的key
	          System.out.println("新增xu002,value002键值对："+shardedJedis.set("xu002", "value002"));
	          ...
	          System.out.println("系统中删除xu002: "+jedis.del("xu002"));
	          System.out.println("判断xu002是否存在："+shardedJedis.exists("xu002"));
	          // 设置 key001的过期时间
	          System.out.println("设置xu001的过期时间为5秒:"+jedis.expire("xu001", 5));
	          try{ 
	              Thread.sleep(2000); 
	          } 
	          ...
	          System.out.println("查看xu001的剩余生存时间："+jedis.ttl("xu001"));
	          // 移除某个key的生存时间
	          System.out.println("移除xu001的生存时间："+jedis.persist("xu001"));
	          System.out.println("查看xu001的剩余生存时间："+jedis.ttl("xu001"));
	          // 查看key所储存的值的类型
	          System.out.println("查看key所储存的值的类型："+jedis.type("xu001"));
	      }
	      ...
	      private void HashOperate() {
	          ...
	          System.out.println("新增key004和4的整型键值对："+shardedJedis.hincrBy("hashs", "key004", 433));
	...
	//List<String> myKey = r.jedis.lrange("numberlists", 0, -1);
		//r.jedis.set("myKey", "xu001");
		List<String> myKey = r.shardedJedis.hvals("hashs");
